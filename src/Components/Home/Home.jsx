...
function Home() {
  ...
  return (
    <>
      ...
      <Link to={"/figure"} onClick={() => window.scrollTo(0, 0)}>
        <FigurePainting />
      </Link>
      <Link to={"/abstract"} onClick={() => window.scrollTo(0, 0)}>
        <Abstract />
      </Link>
      <Link to={"/jewellary"} onClick={() => window.scrollTo(0, 0)}>
        <Jewellary />
      </Link>
      <Link to={"/sculpture"} onClick={() => window.scrollTo(0, 0)}>
        <Sculpture />
      </Link>
      <Footer />
    </>
